"""muslim_hub_2074 URL Configuration
...
admin.site.site_header = 'muslim_hub'
admin.site.site_title = 'muslim_hub Admin Portal'
admin.site.index_title = 'muslim_hub Admin'
